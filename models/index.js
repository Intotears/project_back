...
//บางอันยังไม่เอาออกเพราะเผื่อจะใช้model
...
//db.popular_recipe = require("./popular_recipe.model.js")(sequelize, Sequelize);
db.cooking_process = require("./cooking_process.model.js")(
  sequelize,
  Sequelize
);
//db.unit = require("./unit.model.js")(sequelize, Sequelize);
db.ingrecategories = require("./ingre_categories.model.js")(
  sequelize,
  Sequelize
);
//db.all_ingredients = require("./all_ingredients.model.js")(sequelize, Sequelize);
db.recipes_ingredient = require("./recipes_ingredient.model.js")(
  sequelize,
  Sequelize
);
//db.additional_ingredient = require("./additional_ingredient.model.js")(sequelize, Sequelize);

db.recipe_collection = require("./recipe_collection.model.js")(
  sequelize,
  Sequelize
);
...
//comment m-m
db.recipe.belongsToMany(db.emoji, {
  through: db.comment,
  foreignKey: "recipeID",
});
db.emoji.belongsToMany(db.recipe, {
  through: db.comment,
  foreignKey: "emojiID",
});

//recipe_foodtag m-m
db.recipe.belongsToMany(db.foodtag, {
  through: db.recipe_foodtag,
  foreignKey: "recipeID",
});
db.foodtag.belongsToMany(db.recipe, {
  through: db.recipe_foodtag,
  foreignKey: "tagID",
});
...
db.recipes_ingredient.belongsTo(db.ingrecategories, {
